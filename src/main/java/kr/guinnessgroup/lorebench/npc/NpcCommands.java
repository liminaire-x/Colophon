...
/**
 * <pre>
 * /lorebench npc spawn &lt;id&gt;    place the NPC where you stand (any number of times)
 * /lorebench npc remove         remove the NPC nearest to you (within 4 blocks)
 * /lorebench npc remove &lt;id&gt;   remove every placement of that NPC
 * /lorebench npc list           defined NPCs and how many placements each has
 * </pre>
 */
public final class NpcCommands {
    ...
    public static void register(CommandDispatcher<CommandSourceStack> dispatcher) {
        dispatcher.register(Commands.literal("lorebench")
    ...
    private static int spawn(CommandSourceStack src, String id) throws CommandSyntaxException {
        ...
        NpcEntity npc = LorebenchEntities.NPC.get().create(level);
        if (npc == null) {
            return 0;
        }

...
/** {@code config/colophon-common.toml}. */
public final class ColophonConfig {
    ...
    private ColophonConfig() {}

    public static String serverName() {
        String name = SERVER_NAME.get();
        if (!NAME.matcher(name).matches()) {
            throw new IllegalStateException("colophon-common.toml: serverName '" + name + "' must use a-z, 0-9, _");
        }
        return name;
    }
}

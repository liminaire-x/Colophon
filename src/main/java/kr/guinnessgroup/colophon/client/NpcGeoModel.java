 ...
 * <pre>
 * assets/colophon/geo/npc/&lt;model&gt;.geo.json
 * assets/colophon/animations/npc/&lt;model&gt;.animation.json
 * assets/colophon/textures/npc/&lt;model&gt;.png
 * </pre>
 */
public final class NpcGeoModel extends GeoModel<NpcEntity> {

    static ResourceLocation modelFile(String model) {
        return ResourceLocation.fromNamespaceAndPath(Colophon.MODID, "geo/npc/" + model + ".geo.json");
    }

    static ResourceLocation animationFile(String model) {
        return ResourceLocation.fromNamespaceAndPath(Colophon.MODID, "animations/npc/" + model + ".animation.json");
    }

    static ResourceLocation textureFile(String model) {
        return ResourceLocation.fromNamespaceAndPath(Colophon.MODID, "textures/npc/" + model + ".png");
    }

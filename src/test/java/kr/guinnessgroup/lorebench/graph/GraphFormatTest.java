              ...
              "graphs": [
                {
                  ...
                  "name": "첫 인사",
                  "nodes": [
                    { "id": "node_1", "type": "lorebench:on_player_join", "config": {}, "pos": [100, 80] },
                    { "id": "node_2", "type": "lorebench:has_flag", "config": { "flag": "greeted" }, "pos": [300, 80] },
                    { "id": "node_3", "type": "lorebench:send_message", "config": { "message": "환영합니다" }, "pos": [500, 140] },
                    { "id": "node_4", "type": "lorebench:set_flag", "config": { "flag": "greeted" }, "pos": [700, 140] }
                  ],
                  "links": [
